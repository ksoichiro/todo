...
-- Password is generated by sub-project 'passgen'.
insert ignore into `user` (`id`, `username`, `password`, `enabled`, `created_at`, `updated_at`) values (1, 'test', '$2a$08$b/58wCj8LnxE2yA.1BpYZOiUltmgKjuacM4bYbb2UKppl84ZmRu3.', true, unix_timestamp(), unix_timestamp());
